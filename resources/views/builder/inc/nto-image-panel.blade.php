<div class="content-left-wrapper">
    ...
    <!-- /social -->
    <div>
        <figure><img src="/img/ntodemo.png" alt="" class="img-fluid home-image"></figure>
        <h2>Commerce Cloud Demo Builder</h2>
        <p>Welcome to the Commerce Cloud Demo Builder. This tool will deploy a full functional NTO site to your sandbox
            </p>
