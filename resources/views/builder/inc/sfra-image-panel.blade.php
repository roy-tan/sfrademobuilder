<div class="content-left-wrapper">
    ...
    <!-- /social -->
    <div>
        <figure><img src="/img/sfra-demo.png" alt="" class="img-fluid home-image"></figure>
        <h2>Commerce Cloud Demo Builder</h2>
        <p>Welcome to the Commerce Cloud Demo Builder. This tool will help you to deploy an SFRA storefront + all cartridges + SE Demo Components + Page Designer to your sandbox.
            </p>
