<div class="content-left-wrapper">
    ...
    <div id="social">
        <ul>
            <li><a href="javascript:;" data-toggle="modal" data-target="#load-data"><i class="icon-cog"></i></a></li>
            <li><a href="mailto:{{config('demo.support_email')}}"><i class="icon-email"></i></a></li>
        </ul>
    </div>
    <!-- /social -->
    <div>
        <figure><img src="/img/customdemo.png" alt="" class="img-fluid home-image"></figure>
        <h2>Commerce Cloud Demo Builder</h2>
        <p>Welcome to the Commerce Cloud Demo Builder. This tool will help you to build a fully customized website for a client or a prospect (logo, colors, products and categories).
            </p>
        <a href="javascript:;" data-toggle="modal" data-target="#get-started" class="btn_1 rounded">How does it work ?</a>
        <a href="javascript:;" data-toggle="modal" data-target="#get-started" class="btn_1 rounded mobile_btn">How does it work ?</a>
    </div>
