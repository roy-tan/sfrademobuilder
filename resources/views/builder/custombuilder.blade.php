...
<body>
	...
	<div class="container-fluid full-height">
		<div class="row row-height">
			...
			@include("builder.inc.custom-image-panel")
			</div>
			<!-- /content-left -->

			<div class="col-lg-6 content-right" id="start">
				@if(!isset($is_success))
					@include("builder.inc.custom-form-bloc")
				@else
					@include("builder.inc.custom_success")
				@endif
			</div>
	...
	@include("builder.inc.modal-check-selector")
	@include("builder.inc.modal-get-started")
	@include("builder.inc.modal-load-data")
